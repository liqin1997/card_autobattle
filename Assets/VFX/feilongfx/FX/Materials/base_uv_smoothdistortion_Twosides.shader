...
Shader "base_uv_smoothdistortion_Twosides"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 panner45 = ( 1.0 * _Time.y * appendResult51 + (texCoord3*appendResult54 + 0.0));
				float2 appendResult215 = (float2(_Vector7.x , _Vector7.y));
				float2 appendResult213 = (float2(_Vector6.x , _Vector6.y));
				float2 panner217 = ( 1.0 * _Time.y * appendResult215 + (texCoord3*appendResult213 + 0.0));
				...
				float2 appendResult218 = (float2(texCoord4.z , texCoord4.w));
				float2 panner64 = ( 1.0 * _Time.y * appendResult66 + (texCoord3*appendResult62 + appendResult218));
				...
				float2 lerpResult5 = lerp( panner64 , appendResult7 , texCoord4.x);
				...
				float4 texCoord206 = i.ase_texcoord3;
				texCoord206.xy = i.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult207 = (float3(texCoord206.x , texCoord206.y , texCoord206.z));
				float3 appendResult209 = (float3(_Color1.r , _Color1.g , _Color1.b));
				float2 appendResult70 = (float2(_Vector4.x , _Vector4.y));
				float2 lerpResult84 = lerp( texCoord3 , lerpResult5 , vertex01);
				...
				float smoothstepResult110 = smoothstep( ( _Float7 - (0.5 + (texCoord4.y - 0.0) * (-0.09 - 0.5) / (1.0 - 0.0)) ) , texCoord4.y , temp_output_124_0);
				float3 lerpResult105 = lerp( saturate( (( appendResult35 * appendResult25 * appendResult41 )).xyz ) , ( appendResult207 * appendResult209 ) , ( ( smoothstepResult110 - step( texCoord4.y , temp_output_124_0 ) ) * ( _Color1.a * texCoord206.w ) ));
				...
				float temp_output_59_0 = ( ( _Color0.a * ( tex2DNode2.a * smoothstepResult110 ) * i.ase_color.a ) * saturate( pow( tex2D( _TextureSample3, texCoord55 ).r , _Float0 ) ) );
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.Vector4Node;63;-3681.952,-212.7088;Inherit;False;Property;_Vector2;主纹理缩放;1;0;Create;False;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;4;-3057.027,116.7701;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;65;-3039.504,-221.476;Inherit;False;Property;_Vector3;主纹理速度;2;0;Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;212;-3252.673,-774.5635;Inherit;False;Property;_Vector6;扭曲溶解遮罩贴图缩放;25;0;Create;False;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;52;-2758.177,-1319.626;Inherit;False;Property;_Vector1;扰动贴图缩放;14;0;Create;False;0;0;0;False;0;False;0,0,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;6;-2549.974,-104.853;Inherit;True;Property;_TextureSample1;扭曲贴图;3;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;214;-2697.763,-766.4268;Inherit;False;Property;_Vector7;扭曲溶解遮罩贴图速度;24;0;Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;50;-2307.172,-1212.661;Inherit;False;Property;_Vector0;扰动速度;13;0;Create;False;0;0;0;False;0;False;0,0,0,0;0.4,0.2,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;72;-2514.947,421.5713;Inherit;False;Property;_Vector5;溶解贴图缩放;7;0;Create;False;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;85;-2114.193,7.394458;Inherit;False;Property;vertex01;启用溶解贴图单独流动;15;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;71;-2124.325,440.7203;Inherit;False;Property;_Vector4;溶解贴图速度;6;0;Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;211;-1775.017,-922.7966;Inherit;True;Property;_TextureSample5;扭曲溶解贴图遮罩;23;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;48;-1655.005,-1140.688;Inherit;False;Property;_Float1;扰动强度;12;0;Create;False;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;47;-1773.168,-1438.643;Inherit;True;Property;_TextureSample4;扰动贴图;11;0;Create;False;0;0;0;False;0;False;-1;None;4d063b83542f6d749aafe52a1453b739;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-1375.587,166.5311;Inherit;False;Property;vertex2;启用扰动影响溶解贴图;16;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;75;-1132.477,229.5736;Inherit;False;Property;_Float2;溶解贴图强度 默认0.8;5;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;34;-807.621,-1216.267;Inherit;False;Property;_Color0;主颜色;10;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;0.6460395,0,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-1056.405,-480.3296;Inherit;True;Property;_TextureSample2;溶解贴图;4;0;Create;False;0;0;0;False;0;False;-1;ab55cf0c3f866c648a33ac7834f612b3;ab55cf0c3f866c648a33ac7834f612b3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-938.625,-808.6756;Inherit;True;Property;_TextureSample0;主纹理;0;0;Create;False;0;0;0;False;0;False;-1;3903f265ecb904a93b58e45db099cb32;7c4da7137ff1d20438585a49484a574a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;111;-1077.115,1266.532;Inherit;False;Property;_Float7;smoothstep 默认0.01;18;0;Create;False;0;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;102;-47.75328,-50.40137;Inherit;False;Property;_Color1;边缘颜色;17;1;[HDR];Create;False;0;0;0;False;1;;False;1,0,0,1;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;27;1341.735,1548.869;Inherit;True;Property;_TextureSample3;遮罩;8;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;43;1673.344,1632.749;Inherit;False;Property;_Float0;遮罩强度;9;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;58;1727.62,1235.161;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;145;-244.8989,-2812.575;Inherit;False;Constant;_Float6;Float 6;22;0;Create;True;0;0;0;False;0;False;0.7154;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;144;-261.034,-2972.051;Inherit;False;Constant;_Float4;Float 4;22;0;Create;True;0;0;0;False;0;False;0.2125;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;146;-267.6722,-2689.394;Inherit;False;Constant;_Float8;Float 8;22;0;Create;True;0;0;0;False;0;False;0.0721;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;126;2796.333,230.2669;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1.16;False;3;FLOAT;1.55;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;150;281.4628,-2420.738;Inherit;False;Constant;_Float9;饱和度;24;0;Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;694.6547,-2324.334;Inherit;False;Property;_Float11;辉光范围;21;0;Create;False;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;153;754.8596,-2175.368;Inherit;False;Constant;_Float10;Float 10;22;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;166;1047.827,-2321.808;Inherit;False;Property;_Color2;辉光颜色;19;1;[HDR];Create;False;0;0;0;False;0;False;0,0,0,0;2,2,2,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;177;1540.114,-2028.624;Inherit;False;Property;_Float12;辉光强度;20;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;192;2126.303,-188.4686;Inherit;False;Property;_Float13;软边缘遮罩开关;22;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;80;-1023.515,-15.57392;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1843.978,-554.3501;Float;False;True;-1;2;ASEMaterialInspector;100;5;base_uv_smoothdistortion_Twosides;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;False;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;2;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;2;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;0;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=4D243BB915B9AB29D936BAAAE3DDEC671E79D79D