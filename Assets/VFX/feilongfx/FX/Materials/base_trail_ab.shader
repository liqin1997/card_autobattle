	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 tex2DNode3 = tex2D( _TextureSample0, panner5 );
				float2 uv_TextureSample1 = i.ase_texcoord1.xy * _TextureSample1_ST.xy + _TextureSample1_ST.zw;
				float4 appendResult74 = (float4((( _Color0 * tex2DNode3 * i.ase_color )).rgb , ( tex2DNode3.a * _Color0.a * ( tex2D( _TextureSample1, uv_TextureSample1 ).r * _Float0 ) * i.ase_color.a )));
				
				
				finalColor = appendResult74;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18935
0;28.8;1957;1094;1655.582;590.0027;1;True;True
...
Node;AmplifyShaderEditor.Vector2Node;15;-2763.494,-181.2307;Inherit;False;Property;_scale;缩放;1;0;Create;False;0;0;0;False;0;False;1,1;0.6,0.82;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;27;-939.654,-524.1158;Inherit;False;Property;_Color0;主颜色;8;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;31;-1241.19,-426.5928;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-1112.081,467.317;Inherit;False;Property;_Float0;遮罩强度;9;0;Create;False;0;0;0;False;0;False;1;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-942.0812,225.317;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-662.954,-151.816;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;72;-438.895,64.4142;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-626.0538,125.9841;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;74;-224.4949,140.1142;Inherit;True;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=FE4DF338301032921FC0FE52A1FFC3BAE6ECD152