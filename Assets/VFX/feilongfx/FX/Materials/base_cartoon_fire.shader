...
Shader "base_cartoon_fire"
{
	Properties
	{
		...
		_Float6("外部边宽", Float) = 0.03
		_Float9("内部宽度", Float) = 0.08
		_Float12("中心宽度", Float) = 0.08
		...
		_Float10("扭曲值", Float) = 0
		_Float11("扰动值", Float) = 1
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 tex2DNode90 = tex2D( _TextureSample1, uv_TextureSample1 );
				float2 temp_cast_1 = (tex2DNode90.r).xx;
				...
				float4 tex2DNode83 = tex2D( _TextureSample0, uv_TextureSample0 );
				float2 appendResult85 = (float2(tex2DNode83.r , tex2DNode83.g));
				float2 lerpResult82 = lerp( uv04 , appendResult85 , _Float10);
				float2 lerpResult91 = lerp( temp_cast_1 , lerpResult82 , _Float11);
				float2 panner6 = ( 1.0 * _Time.y * appendResult11 + (lerpResult91*1.0 + 0.0));
				...
				float2 temp_cast_3 = (tex2DNode90.r).xx;
				float2 appendResult33 = (float2(_Vector1.x , _Vector1.y));
				float2 uv030 = i.ase_texcoord.xy * appendResult33 + float2( 0,0 );
				float2 lerpResult86 = lerp( uv030 , appendResult85 , _Float10);
				float2 lerpResult99 = lerp( temp_cast_3 , lerpResult86 , _Float11);
				float2 panner28 = ( 1.0 * _Time.y * appendResult31 + (lerpResult99*1.0 + 0.0));
				...
				float2 temp_cast_4 = (tex2DNode90.r).xx;
				float2 uv039 = i.ase_texcoord.xy * float2( 1,1 ) + float2( -0.5,-0.5 );
				float2 lerpResult100 = lerp( temp_cast_4 , uv039 , _Float11);
				float temp_output_48_0 = (1.0 + (length( lerpResult100 ) - 0.0) * (0.0 - 1.0) / (_Float3 - 0.0));
				...
				float2 uv1103 = i.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult62 = lerp( _Color1 , _Color0 , step( temp_output_79_0 , ( uv1103.x + _Float6 ) ));
				float4 lerpResult63 = lerp( _Color3 , lerpResult62 , step( temp_output_79_0 , ( uv1103.x + _Float9 ) ));
				float4 lerpResult113 = lerp( _Color2 , lerpResult63 , step( temp_output_79_0 , ( uv1103.x + _Float12 ) ));
...
/*ASEBEGIN
Version=17500
0;0;1957;1131;2421.053;-573.4945;1.292327;True;True
Node;AmplifyShaderEditor.SamplerNode;83;-5312.041,5.727901;Inherit;True;Property;_TextureSample0;扭曲贴图;12;0;Create;False;0;0;False;0;-1;1ee2155ebc7acdd469a932f74ee1b951;402332fae5957ec4ea52e16593aa3f83;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;20;-4476.453,-384.1766;Inherit;False;Property;_Vector0;纹理1tilling/speed;0;0;Create;False;0;0;False;0;2,1,0,-1;2,1,0,0.5;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;32;-4690.415,621.0383;Inherit;False;Property;_Vector1;纹理2tilling/speed;1;0;Create;False;0;0;False;0;2,1,0,-0.5;1,1,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;85;-4771.252,-11.09914;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.WireNode;95;-4227.773,245.1517;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;84;-4609.256,5.018017;Inherit;False;Property;_Float10;扭曲值;14;0;Create;False;0;0;False;0;0;0.65;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;93;-4480.686,-610.821;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;90;-3552.809,-1175.19;Inherit;True;Property;_TextureSample1;扰动贴图;13;0;Create;False;0;0;False;0;-1;3c2220205bf33b74e91fb46cd5858af1;cd460ee4ac5c1e746b7a734cc7cc64dd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;92;-3732.163,-875.7482;Inherit;False;Property;_Float11;扰动值;15;0;Create;False;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;82;-3489.273,-686.1921;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;86;-3653.441,66.30445;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;99;-3253.309,-97.33443;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.LerpOp;91;-3085.78,-1022.862;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-2173.843,521.8359;Inherit;False;Property;_Float8;火焰扭曲程度;10;0;Create;False;0;0;False;0;1.55;3.46;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;56;-4039.594,1486.967;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;100;-3374.206,518.43;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.OneMinusNode;58;-3394.567,1566.985;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-3486.54,1335.749;Inherit;False;Property;_Float3;火焰范围;9;0;Create;False;0;0;False;0;0.4041452;0.553;0;1.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.LengthOpNode;42;-3447.46,1071.695;Inherit;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-3163.653,1760.983;Inherit;False;Property;_Float7;边缘强度;11;0;Create;False;0;0;False;0;0.5;0.89;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;68;-3003.524,1602.674;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-1914.509,1857.686;Inherit;True;Property;_Float4;遮罩强度;17;0;Create;False;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;104;-2216.715,1459.527;Inherit;True;Property;_TextureSample2;mask;16;0;Create;False;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-1592.645,1326.968;Inherit;False;Property;_Float6;外部边宽;6;0;Create;False;0;0;False;0;0.03;0.11;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;103;-2044.746,894.598;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-1579.838,1579.449;Inherit;False;Property;_Float9;内部宽度;7;0;Create;False;0;0;False;0;0.08;0.23;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;67;-1356.645,1213.968;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;60;-1242.988,-193.3197;Inherit;False;Property;_Color1;中间颜色;3;0;Create;False;0;0;False;0;1,0,0,0;1,0.156769,0.09803921,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;64;-1124.645,1179.968;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;112;-1564.446,1758.341;Inherit;False;Property;_Float12;中心宽度;8;0;Create;False;0;0;False;0;0.08;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;114;-995.4243,-304.1781;Inherit;False;Property;_Color3;内部颜色;4;0;Create;False;0;0;False;0;1,0.6284041,0,0;1,0.7748438,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;61;-869.652,-584.4229;Inherit;False;Property;_Color2;高光;5;0;Create;False;0;0;False;0;1,0.6284041,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;87;-3637.281,702.0111;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;94;-4448.572,550.8669;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
WireConnection;99;0;90;1
WireConnection;99;1;86;0
WireConnection;99;2;92;0
...
WireConnection;100;0;90;1
WireConnection;100;1;39;0
...
ASEEND*/
//CHKSM=7704CC82B0D7AEC61CC9B6C01B533DC766868671