...
Shader "base_uv_distortion_vertex"
{
	Properties
	{
		...
		_TextureSample6("偏移遮罩", 2D) = "white" {}
		_Float6("UV2 启用CustomData （XYZ偏移）", Float) = 0
		[Enum(Z_On,1,Z_OFF,0)]_Float7("Z_Off_开关", Float) = 1
	...
	LOD 100
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float2 uv_TextureSample6 = v.ase_texcoord.xy * _TextureSample6_ST.xy + _TextureSample6_ST.zw;
				float4 uv2189 = v.ase_texcoord2;
				uv2189.xy = v.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult191 = (float3(uv2189.x , uv2189.y , uv2189.z));
				float3 lerpResult192 = lerp( _Vector6 , appendResult191 , _Float6);
				...
				float3 lerpResult153 = lerp( ( lerpResult192 * (-0.5 + (tex2DNode87.r - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ) , ( ( ( 1.0 - tex2DNode87.r ) * _Float4 ) * normalizeResult181 ) , _Float5);
				...
				#endif
				vertexValue = ( tex2Dlod( _TextureSample6, float4( uv_TextureSample6, 0, 0.0) ).r * lerpResult153 );
				#if ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=17500
-2041.6;0.8;1957;1122;-676.5553;825.82;1;True;True
...
Node;AmplifyShaderEditor.Vector4Node;65;-2814.672,-228.3939;Inherit;False;Property;_Vector3;主纹理速度;2;0;Create;False;0;0;False;0;0,0,0,0;0,0.5,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;92;-314.6032,863.263;Inherit;False;Property;vertexmap;置换贴图速度;19;0;Create;False;0;0;False;0;0,0,0,0;0,0.5,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-1007.625,-785.6756;Inherit;True;Property;_TextureSample0;主纹理;0;0;Create;False;0;0;False;0;-1;None;07c712ecc7aa66149bac518d083b0d88;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;189;560.1052,-862.8712;Inherit;False;2;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;151;382.9361,537.2143;Inherit;False;Property;_Float4;整体偏移强度;21;0;Create;False;0;0;False;0;0;0.52;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;193;817.2612,-249.3293;Inherit;False;Property;_Float6;UV2 启用CustomData （XYZ偏移）;29;0;Create;False;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;191;592.2391,-433.9869;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;192;1040.261,-453.3293;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;186;809.4011,-77.70715;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-0.5;False;4;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;155;1815.347,139.9966;Inherit;False;Property;_Float5;各方向偏移;22;0;Create;False;0;0;False;0;0;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;154;1066.845,-279.2662;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;153;1498.321,-204.5111;Inherit;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;187;1262.099,-489.2732;Inherit;True;Property;_TextureSample6;偏移遮罩;28;0;Create;False;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;188;1775.228,-424.9559;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;209;1583.336,353.8663;Inherit;True;Property;_Float7;Z_Off_开关;30;1;[Enum];Create;False;2;Z_On;1;Z_OFF;0;0;True;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;125;1705.037,-625.9146;Float;False;True;-1;2;ASEMaterialInspector;100;1;base_uv_distortion_vertex;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;True;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;True;209;True;0;False;-1;True;True;0;False;-1;0;False;-1;True;2;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;2;0;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;0
...
WireConnection;191;0;189;1
WireConnection;191;1;189;2
WireConnection;191;2;189;3
...
WireConnection;154;0;192;0
WireConnection;154;1;186;0
...
WireConnection;125;1;188;0
ASEEND*/
//CHKSM=AD4D5ABD2D44CFF06C528B4093DB18ACC2B2A250